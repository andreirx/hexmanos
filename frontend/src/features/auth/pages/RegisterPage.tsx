      ...
      <div className="w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-2 px-4 bg-white hover:bg-gray-100 disabled:bg-gray-200 disabled:cursor-not-allowed text-gray-800 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
          >
            <GoogleIcon />
            Sign up with Google
          </button>
